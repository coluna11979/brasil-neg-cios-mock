  ...
  return (
    <CorretorLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="rounded-2xl bg-gradient-to-br from-primary/10 to-violet-50 border border-primary/10 px-6 py-5 space-y-3">
          ...
          <FaithQuote variant="muted" className="pt-2 border-t border-primary/10" />
        </div>
